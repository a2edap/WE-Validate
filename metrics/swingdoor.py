...
#%%
# datadir = r'C:\Users\monc573\OneDrive - PNNL\Documents\WECC'
...
class swingdoor:
    def compute(self, x, y):
        ...
        #    "magnitude", "rate" and "duration", respectively.
            ...
            b_mag,b_rate,b_dur,b_t = swingdoor(z.iloc[:,0])
            c_mag,c_rate,c_dur,c_t = swingdoor(z.iloc[:,1])
            plt.plot(b_t,b_dur)
            plt.plot(c_t,c_dur)
            plt.show()
